...
import com.sergeyivanov.spring.mvc.validation.CheckEmail;
...
//    @NotEmpty(message = "surname is required field")
    ...
    @Min(value = 500, message = "value can't be less than 500")
    @Max(value = 1000, message = "value can't be greater than 1000")
    private  int salary;
